...
import { WebPlatform } from "../index";
import { setThreeVectorFromGlVec3, setThreeColorFromGlVec3 } from "./three-utils";
...
export class ThreeRenderer {
    ...
    constructor(meshProvider: ThreeMeshProvider, webPlatform: WebPlatform){
